...
export function DashboardFrame() {
  // Responsive: expanded sidebar on desktop, collapsed icon-rail on smaller screens.
  // Controlled so it re-syncs on resize while still letting the user toggle.
                  ...
                  <tbody>
                    {ORDERS.map((o) => (
                      <tr key={o.id} className="border-b border-border last:border-0">
                        ...
                        <td className="whitespace-nowrap px-4 py-3 font-medium text-foreground">{o.customer}</td>
                        ...
                        <td className="whitespace-nowrap px-4 py-3 text-right text-muted-foreground">{o.date}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
